		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form action="addecg" method="post" enctype="multipart/form-data">
					<span class="login100-form-title p-b-33"> Plik EKG. <br>
					<br> Dane pacjenta
					</span>

					<div class="wrap-input100">
						Nazwisko: <input class="input100" type="text" name="nazwisko"
							readonly="readonly" value="${nazwisko}" /> <span
							class="focus-input100-1"></span> <span class="focus-input100-2"></span>
					</div>

					<div class="wrap-input100">
						Imie: <input class="input100" type="text" name="imie"
							readonly="readonly" value="${imie}"> <span
							class="focus-input100-1"></span> <span class="focus-input100-2"></span>
					</div>

					<div class="wrap-input100">
						Pesel: <input class="input100" type="text" name="pesel"
							readonly="readonly" value="${pesel}"> <span
							class="focus-input100-1"></span> <span class="focus-input100-2"></span>
					</div>

					<div class="container-login100-form-btn m-t-20">
						<form action="addecg" method="POST"
							class="login100-form-btn m-t-20">
					...
					<div class="container-login100-form-btn m-t-20">
						<button class="login100-form-btn" type="button"
							onClick="window.location='\start.jsp'">Wroc do startu</button>
					</div>

					<div class="container-login100-form-btn m-t-20">
						<button type="button" class="login100-form-btn"
							onClick="window.location='\selectPacjentWindow.jsp'">
							Wyszukaj pacjenta</button>

					</div>

					<div class="container-login100-form-btn m-t-20">
						<button class="login100-form-btn">Otworz istniejace
							badania</button>
					</div>
...
downloadLnk.addEventListener('click', download, false);
		...
		if ( sAction != null && (sAction).equals("error")) { %>
					<script> alert("Bledny plik");</script>
					<% }
